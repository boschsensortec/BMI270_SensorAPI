...
BMI2_INTF_RETURN_TYPE bmi2_i2c_write(uint8_t reg_addr, const uint8_t *reg_data, uint32_t len, void *intf_ptr)
{
    ...
    return coines_write_i2c((enum coines_i2c_bus)intf_info.bus, intf_info.dev_addr, reg_addr, (uint8_t *)reg_data,
                            (uint16_t)len);
}
...
BMI2_INTF_RETURN_TYPE bmi2_spi_read(uint8_t reg_addr, uint8_t *reg_data, uint32_t len, void *intf_ptr)
{
    ...
    return coines_read_spi((enum coines_spi_bus)intf_info.bus, intf_info.dev_addr, reg_addr, reg_data, (uint16_t)len);
}
...
BMI2_INTF_RETURN_TYPE bmi2_spi_write(uint8_t reg_addr, const uint8_t *reg_data, uint32_t len, void *intf_ptr)
{
    ...
    return coines_write_spi((enum coines_spi_bus)intf_info.bus, intf_info.dev_addr, reg_addr, (uint8_t *)reg_data,
                            (uint16_t)len);
}
